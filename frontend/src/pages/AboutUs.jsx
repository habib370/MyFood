  ...
  const teamMembers = [
    {
      ...
      role: "CEO & Founder",
      image:
        "https://tse2.mm.bing.net/th/id/OIP.lbD25wKYnLzxz6PeHkQvywHaHC?pid=Api&P=0&h=220",
    ...
    },
    {
      ...
      image:
        "https://imgcdn.stablediffusionweb.com/2024/9/14/32126d8d-b1ea-4a60-9878-b2f729b566fa.jpg",
    ...
    },
    {
      ...
      role: "Tech Director",
      image:
        "https://tse1.mm.bing.net/th/id/OIP.z4tCNXMWxa-mWMLiBLuTgQHaEJ?pid=Api&P=0&h=220",
      bio: "Technology enthusiast driving innovation",
    },
    {
      name: "mr motu",
      image:
        "https://tse1.mm.bing.net/th/id/OIP.uANHyvwitj-Cj_IqT52VGQHaEK?pid=Api&P=0&h=220",
  ...
  const milestones = [
    {
      year: "2018",
      title: "Founded",
      description: "Started as a small online grocery store",
    },
    {
      year: "2019",
      title: "10K Customers",
      description: "Reached milestone of 10,000 happy customers",
    },
    {
      year: "2020",
      title: "Nationwide Delivery",
      description: "Expanded delivery to all 64 districts",
    },
    {
      year: "2021",
      title: "Mobile App Launch",
      description: "Launched iOS & Android applications",
    },
    {
      year: "2022",
      title: "1M+ Orders",
      description: "Processed over 1 million successful orders",
    },
    {
      year: "2023",
      title: "Award Winner",
      description: "Best E-commerce Platform of the Year",
    },
  ];
        ...
        <div className="relative z-20 h-full flex flex-col justify-center items-center text-white px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-200 max-w-3xl mx-auto">
              Bangladesh's most trusted online marketplace, connecting millions
              to quality products with convenience and care
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                to="/"
                onClick={() => window.scrollTo(0, 0)}
                className="px-8 py-3 bg-yellow-500 text-gray-900 font-semibold rounded-full hover:bg-yellow-600 transition-all transform hover:scale-105 shadow-lg"
              >
                Shop Now
              </Link>
              <button
                onClick={() => alert("goriber story hoi na re paglaa")}
                className="px-8 py-3 border-2 border-white text-white font-semibold rounded-full hover:bg-white/10 transition-all shadow-lg"
              >
                Our Story
              </button>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-700 text-lg mb-6">
              Founded in 2018, My Food began with a simple vision: to make
              shopping accessible, convenient, and trustworthy for every
              Bangladeshi household. What started as a small online grocery
              service has grown into a comprehensive marketplace serving
              millions.
            </p>
            <p className="text-gray-700 text-lg mb-8">
              Today, we're proud to be Bangladesh's fastest-growing e-commerce
              platform, revolutionizing how people shop by combining technology
              with a deep understanding of local needs and preferences.
            </p>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  From startup to market leader in 5 years
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 max-w-full mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Milestones that shaped My Food
          </p>
        </div>
        <div className="relative">
          {/* Timeline line */}
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                <div className="md:w-1/2 md:px-8">
                  <div
                    className={`bg-white p-6 rounded-2xl shadow-lg ${index % 2 === 0 ? "md:text-right" : ""}`}
                  >
      ...
      <section className="py-20 px-4 max-w-full mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-700 text-lg mb-6">
              We're not just building an e-commerce platform; we're creating an
              ecosystem that empowers Bangladeshi businesses, supports local
              communities, and makes quality products accessible to all.
            </p>
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Bringing every local shop online by 2025
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-yellow-400 to-orange-500 text-gray-900">
        <div className=" flex flex-col items-center max-w-full mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6">
            Ready to Experience My Food?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join millions of satisfied customers who trust us for their daily
            needs
          </p>
          <div className="flex flex-wrap justify-center gap-6">
            <button
              onClick={() => alert("goriber abr app hoi na re pagla")}
              className="px-8 py-3 bg-gray-900 text-white font-semibold rounded-full hover:bg-black transition-all transform hover:scale-105 shadow-lg"
            >
              Download Our App
            </button>
            <Link
              to="/"
              onClick={() => window.scrollTo(0, 0)}
              className="px-8 py-3 bg-white text-gray-900 font-semibold rounded-full hover:bg-gray-100 transition-all shadow-lg"
            >
              Explore Products
            </Link>
            <button
              onClick={() => alert("Tekaa achee???😒")}
              className="px-8 py-3 border-2 border-gray-900 text-gray-900 font-semibold rounded-full hover:bg-gray-900/10 transition-all shadow-lg"
            >
              Partner With Us
            </button>
          </div>
