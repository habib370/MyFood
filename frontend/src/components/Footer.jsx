        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-gray-300 leading-relaxed text-sm lg:text-base">
                Delivering delicious meals right to your doorstep. Experience the finest cuisine with our fast delivery and exceptional service.
              </p>
              ...
              <div className="flex gap-4">
                {[
                  ...
                  { icon: assets.linkedin_icon, name: "LinkedIn", color: "hover:bg-blue-700" }
                ].map((social, index) => (
                  <div
                    key={index}
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-3">
              {[
                "Home", "About Us", "Our Menu", "Delivery Areas", 
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 group cursor-pointer">
                ...
                <div>
                  <p className="text-gray-300 group-hover:text-green-400 transition-colors font-medium">+088-123-456-789</p>
              ...
              <div className="flex items-start gap-3 group cursor-pointer">
                ...
                <div>
                  <p className="text-gray-300 group-hover:text-green-400 transition-colors font-medium">contact@myfood.com</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Akhaura, Brahman-baria</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700 hover:border-purple-500 transition-all duration-300">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2 text-gray-300">
                  ...
                  <span>React.js • Node.js • MongoDB • Express</span>
                </div>
              </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="flex gap-2">
                {["💳", "📱", "🔗", "💵"].map((method, index) => (
                  <div key={index} className="w-8 h-8 bg-gray-700 rounded flex items-center justify-center text-sm">
                    {method}
                  </div>
                ))}
              </div>
